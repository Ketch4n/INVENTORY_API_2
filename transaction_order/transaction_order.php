...
$sqlStocks = "INSERT INTO orders (item_id, item_name, customer_id, customer_name, customer_store, customer_location, price, markup, retail, order_quantity, payment,status, date) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?, ?)";
$response = array();
...
if ($stmt) {
    // Bind parameters
    $stmt->bind_param("sssssssssssss", $item_id, $item_name, $customer_id, $customer_name, $customer_store, $customer_location, $price, $markup, $retail, $quantity, $payment, $status,$dateFormatted);
